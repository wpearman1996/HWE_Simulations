...
out_any<-admix_plot(clummped_low_dat$hwe_out_across,10,180,6,F,brewer.pal(k,"Paired"),"Out Any")
out_all<-admix_plot(clummped_low_dat$hwe_out_across,10,180,6,F,brewer.pal(k,"Paired"),"Out All")
nofilt<-admix_plot(clummped_low_dat$hwe_out_across,10,180,6,F,brewer.pal(k,"Paired"),"No Filt")
