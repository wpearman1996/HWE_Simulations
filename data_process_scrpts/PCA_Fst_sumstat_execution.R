...
write.csv(z,paste0(opt$dir,opt$pre,"PCA_matrix.csv"))
write.csv(fst_matrix,paste0(opt$dir,opt$pre,"Fst_matrix.csv"))
write.csv(file_fis$overall,paste0(opt$dir,opt$pre,"summary_stats.csv"))
